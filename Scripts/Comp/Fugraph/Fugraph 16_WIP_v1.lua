        ...
        ui:Stack
        {
            ...
            ui:HGroup 
              ...
              ui:HGroup 
              {
                ...
                ui:Button{ID = 'Ctrans',Icon = ui:Icon{File = 'Scripts:/Comp/Fugraph/UI Manager/Ctrans.png'}, Flat = true,IconSize = {65,65},MaximumSize = {65,65},MinimumSize = {65,65}},
                ui:Button{ID = 'Nobe',Icon = ui:Icon{File = 'Scripts:/Comp/Fugraph/UI Manager/Nobe.png'}, Flat = true,IconSize = {65,65},MaximumSize = {65,65},MinimumSize = {65,65}},
...
function win.On.Ctrans.Clicked(ev)
  local tools = comp:GetToolList(true)

  pivot = tools[1].Center[CurrentTime]
  AddTool("Transform", -32768, -32768)
  local tools = comp:GetToolList(true)
  tools[1].Pivot = pivot
end

function win.On.Nobe.Clicked(ev)
  --local tools = comp:GetToolList(true)
  --local tool = tools[1]
  --print(tool)

  local resolve = Resolve()
  local del = resolve:OpenPage("Fairlight")
  local del = resolve:OpenPage("Fusion")
  --flow.Select(tool[1])
