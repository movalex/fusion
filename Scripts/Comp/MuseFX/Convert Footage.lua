...
------------------------------------------------------------------------------------------------
--		Convert Footage.eyeonscript,Revision 8
--
--
...
--		Update Jul 20 2006 - include some utility functions and added convertion between all known to fusion fileformats
...
-- 		Update Aug 22 2017 - Port to Fusion 8 by Bryan Ray
--
...
templates_path = [[X:\rnd\_defaults\templates\fus\]]
...
alert('Can\'t get list of file formats, aborting the srcipt!')
do return end
end
exts2=exts
...
--------------------------------------------------\n
set in the beginig of this script is NOT VALID!
...
opts = {
	{
		...
		"Dropdown",
		Options = exts,
		Default = (_cfs["mask"]or 17),
	},{
		"sq",
		Name = 'Convert to:',
		"Dropdown",
		Options = exts2,
		Default = (_cfs["sq"]or 0),
	},{
		"Destination",
		Name = "Save clips to:",
		"PathBrowse",
