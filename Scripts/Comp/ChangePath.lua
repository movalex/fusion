...
d[6] = {"Replacement", "Text", Name = "Enter the replacement", Default = lastReplacement}
...
if x then
   ...
   -- srchFor = string.gsub(x.Source, "%s+$", "")
   -- srchFor = string.gsub(srchFor, "^%s+", "")
   -- srchTo = string.gsub(x.Replacement, "%s+$", "")
   -- srchTo = string.gsub(srchTo, "^%s+", "")
